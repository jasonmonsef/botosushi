...
Contributors: David Marcucci
Donate link: http://david.marcucci.org/wppassprotect
Tags: force, login, password, protect
...
1. Upload `wp_passprotect.php` to the `/wp-content/plugins/password-protect-plugin-for-wordpress/` directory
...
1. The login screen with the new login message.
